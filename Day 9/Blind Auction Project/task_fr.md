L'objectif est de construire un programme d'enchères à l'aveugle.

### Démo
https://appbrewery.github.io/python-day9-demo/

### Effacer la Sortie
Il existe plusieurs façons d'effacer la sortie. La plus simple est de simplement imprimer `"\n"` plusieurs fois pour que la sortie défile sur plusieurs lignes.

par exemple:
```
# Ceci ajoutera 20 nouvelles lignes à la sortie
print("\n" * 20)
```

### Fonctionnalité
- Chaque personne écrit son nom et son offre.
- Le programme demande s'il y en a d'autres qui ont besoin de faire une offre. Si oui, alors l'ordinateur efface la sortie (imprime plusieurs lignes vides) puis revient à la question du nom et de l'offre.
- Le nom et l'offre de chaque personne sont sauvegardés dans un dictionnaire.
- Une fois que tous les participants ont fait leur offre, le programme détermine qui a la plus haute offre et l'imprime.
